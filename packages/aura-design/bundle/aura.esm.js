...
const _tmpl$ = /*#__PURE__*/template(`<style></style>`),
  _tmpl$2 = /*#__PURE__*/template(`<div class="bg"><button>Click <span></span></button></div>`);
const Counter = props => {
...
var CustomElements = /*#__PURE__*/Object.freeze({
  __proto__: null,
  Counter: Counter$1
});

const defineCustomElements = (elements = CustomElements) => {
...
export { Counter$1 as Counter, defineCustomElements };
